...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    create_at: Schema.Attribute.Date;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.String;
    ...
    price_children: Schema.Attribute.Decimal;
    price_pmr: Schema.Attribute.Decimal;
    price_standard: Schema.Attribute.Decimal;
    price_student: Schema.Attribute.Decimal;
    price_vip: Schema.Attribute.Decimal;
    publishedAt: Schema.Attribute.DateTime;
    scan: Schema.Attribute.Relation<'manyToOne', 'api::scan.scan'>;
...
export interface ApiScanScan extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::scan.scan'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    scan_date: Schema.Attribute.Date;
    scan_status: Schema.Attribute.Enumeration<
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    users: Schema.Attribute.Relation<'oneToMany', 'api::event.event'>;
  };
}
...
export interface ApiSeatSeat extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::seat.seat'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    seat_number: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 4;
        minLength: 4;
      }> &
      Schema.Attribute.DefaultTo<'A001'>;
    seat_type: Schema.Attribute.Enumeration<
      ['Standard', 'VIP', 'PMR', 'Enfant', 'Etudiant']
    >;
    statu: Schema.Attribute.Enumeration<['available', 'reserved', 'occupied']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiTicketTicket extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    name_event: Schema.Attribute.String;
    price: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
    purchase_date: Schema.Attribute.Date;
    qr_code: Schema.Attribute.String;
    quantity: Schema.Attribute.Integer;
    scan: Schema.Attribute.Relation<'oneToOne', 'api::scan.scan'>;
    statu: Schema.Attribute.Enumeration<['valid', 'scanned', 'canceled']>;
    ticket_type: Schema.Attribute.Enumeration<
      [
        'standardTickets',
        'vipTickets',
        'pmrTickets',
